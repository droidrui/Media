...
public class EncodeActivity extends Activity {
    ...
    private EncodeActivity.CodecInputSurface mInputSurface;
    ...
    private EncodeActivity.SurfaceTextureManager mStManager;
     ...
     * test entry point
     */
    public void testEncodeCameraToMp4() {
        try {
            encodeCameraToMpeg();
        } catch (Throwable e) {
            e.printStackTrace();
    ...
    private void prepareSurfaceTexture() {
        mStManager = new EncodeActivity.SurfaceTextureManager();
        SurfaceTexture st = mStManager.getSurfaceTexture();
        try {
    ...
    private void prepareEncoder(int width, int height, int bitRate) throws IOException {
        ...
        mInputSurface = new EncodeActivity.CodecInputSurface(mEncoder.createInputSurface());
        mEncoder.start();
    ...
    private static class SurfaceTextureManager
        ...
        private EncodeActivity.STextureRender mTextureRender;
        ...
        public SurfaceTextureManager() {
            mTextureRender = new EncodeActivity.STextureRender();
